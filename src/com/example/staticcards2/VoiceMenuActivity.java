   ...
   private boolean mVoiceMenuEnabled = true;
    ...
    private List<Card> createCards(Context context) {
        ...
        Card card = new Card(context)
                ...
                .setText("Sample voice menu activity. Tap to toggle voice menu.");
        cards.add(card);
        return cards;
    }
    ...
    private int getImageResource() {
        switch (mPicture) {
            case 1:  return R.drawable.ic_launcher;
            case 2:  return R.drawable.ic_launcher;
            case 3:  return R.drawable.ic_launcher;
            case 4:  return R.drawable.ic_launcher;
            case 5:  return R.drawable.ic_launcher;
            case 6:  return R.drawable.ic_launcher;
